...
public class ItemsRegister {
    ...
    public static final DeferredItem<Item> LEVITATION_STONE = ITEMS.registerItem("levitation_stone", LevitationStone::new, properties -> properties.stacksTo(1));

    public static final DeferredItem<BlockItem> RED_DOOR = ITEMS.registerSimpleBlockItem("red_door", BlockRegister.RED_DOOR);
    public static final DeferredItem<BlockItem> BLUE_DOOR = ITEMS.registerSimpleBlockItem("blue_door", BlockRegister.BLUE_DOOR);
    public static final DeferredItem<BlockItem> YELLOW_DOOR = ITEMS.registerSimpleBlockItem("yellow_door", BlockRegister.YELLOW_DOOR);
    public static final DeferredItem<BlockItem> FAKE_BEACON = ITEMS.registerSimpleBlockItem("fake_beacon", BlockRegister.FAKE_BEACON, properties -> properties.rarity(Rarity.RARE));
    public static final DeferredItem<BlockItem> LAPUTA_MINIATURE = ITEMS.registerSimpleBlockItem("laputa_miniature", BlockRegister.LAPUTA_MINIATURE, properties -> properties.rarity(Rarity.EPIC));

    public static final DeferredItem<Item> RED_KEY = ITEMS.registerItem("red_key", KeyItem::new);
    public static final DeferredItem<Item> BLUE_KEY = ITEMS.registerItem("blue_key", KeyItem::new);
    public static final DeferredItem<Item> YELLOW_KEY = ITEMS.registerItem("yellow_key", KeyItem::new);

    public static final DeferredItem<BlockItem> LAPUTA_CORE = ITEMS.registerSimpleBlockItem("laputa_core", BlockRegister.LAPUTA_CORE);
