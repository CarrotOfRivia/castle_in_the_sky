...
public class ItemsRegister {
    ...
    public static final RegistryObject<Item> LAPUTA_MINIATURE = ITEMS.register("laputa_miniature", ()->new BlockItem(BlockRegister.LAPUTA_MINIATURE.get(), new Item.Properties().tab(CastleInTheSky.ITEM_GROUP).rarity(Rarity.EPIC)));
